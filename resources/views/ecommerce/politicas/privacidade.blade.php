        ...
        <div style="padding-bottom: 500px; border-radius: 10px; background-color: rgba(240, 240, 240, 0.6);" class="container">
            ...
            <p>A sua privacidade é importante para nós. É política do Selaria SGV respeitar a sua privacidade em relação
                a qualquer informação sua que possamos coletar no site <a href=http://www.sistemasgv.com.br>Selaria
                    SGV</a>, e outros sites que possuímos e operamos.</p>
            ...
            <h2>Política de Cookies Selaria SGV</h2>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Selaria SGV oferece no
            ...
            <ul>
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Selaria SGV, de seus
            ...
            <p>Esta política é efetiva a partir de <strong>Maio</strong>/<strong>2022</strong>.</p>
        </div>
