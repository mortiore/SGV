...
<main>
        <div style="padding-bottom: 500px; border-radius: 10px; background-color: rgba(240, 240, 240, 0.6);" class="container">
            ...
            <p>É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no
                site Selaria SGV , apenas para visualização transitória pessoal e não comercial. Esta é a concessão de
            ...
            <ol>
                ...
                <li>usar os materiais para qualquer finalidade comercial ou para exibição pública (comercial ou não
                    comercial);</li>
                <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Selaria SGV;                </li>
            ...
            <p>Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser
                rescindida por Selaria SGV a qualquer momento. Ao encerrar a visualização desses materiais ou após o
            ...
            <ol>
                <li>Os materiais no site da Selaria SGV são fornecidos 'como estão'. Selaria SGV não oferece garantias,
                ...
                <li>Além disso, o Selaria SGV não garante ou faz qualquer representação relativa à precisão, aos
            ...
            <h2>4. Limitações</h2>
            <p>Em nenhum caso o Selaria SGV ou seus fornecedores serão responsáveis por quaisquer danos (incluindo,
                sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do
                uso ou da incapacidade de usar os materiais em Selaria SGV, mesmo que Selaria SGV ou um representante
                autorizado da Selaria SGV tenha sido notificado oralmente ou por escrito da possibilidade de tais danos.
            ...
            <p>Os materiais exibidos no site da Selaria SGV podem incluir erros técnicos, tipográficos ou fotográficos.
                Selaria SGV não garante que qualquer material em seu site seja preciso, completo ou atual. Selaria SGV
                pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No
                entanto, Selaria SGV não se compromete a atualizar os materiais.</p>
            <h2>6. Links</h2>
            <p>O Selaria SGV não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo de
                nenhum site vinculado. A inclusão de qualquer link não implica endosso por Selaria SGV do site. O uso de
                qualquer site vinculado é por conta e risco do usuário.</p>
            </p>
            <h3>Modificações</h3>
            <p>O Selaria SGV pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio. Ao usar
                este site, você concorda em ficar vinculado à versão atual desses termos de serviço.</p>
            <h3>Lei aplicável</h3>
            <p>Estes termos e condições são regidos e interpretados de acordo com as leis do Selaria SGV e você se
